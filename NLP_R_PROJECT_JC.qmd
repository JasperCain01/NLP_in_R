...
There are many more bigrams which are of equal frequency compared to single words for each author. Like the word frequency analysis, it is clear to see what further cleanisng would be needed to make this more useful - e.g. Friday Briefings.
